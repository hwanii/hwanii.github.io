$(function () {
    ...
    $(window).scroll(function(){
		...
		if(t < h - 400){
            ...
            $(".left-name p").text("한숨").css({color : "#fff",
                                             top : "50px",
                                             left : "8px"});
            ...
            $(".left-name p").text("한국문물연구원").css({color : "#666",
                                                  top : "100px",
                                                  left : "-12px"});
            $(".copy").css({color : "#666"});
		}else if(t < 3*h - 400){
            ...
            $(".left-name span").css({background : "#fff"});
            $(".left-name p").text("레오폴드").css({color : "#fff",
                                                  top : "70px",
                                                  left : "0px"});
            $(".copy").css({color : "#ebebeb"});
		}else if(t < 4*h - 400){
            ...
            $(".left-name span").css({background : "#666"});
            $(".left-name p").text("유플러스").css({color : "#666",
                                                  top : "70px",
                                                  left : "-1px"});
            $(".copy").css({color : "#666"});
		}else if(t < 5*h - 400){
            ...
            $(".left-name span").css({background : "#fff"});
            $(".left-name p").text("동구바이오제약").css({color : "#fff",
                                                  top : "100px",
                                                  left : "-12px"});
            $(".copy").css({color : "#ebebeb"});
		}else if(t < 6*h - 400){
            ...
            $(".left-name span").css({background : "#666"});
            $(".left-name p").text("스카이데포레").css({color : "#666",
                                                  top : "90px",
                                                  left : "-4px"});
            $(".copy").css({color : "#666"});
		}
